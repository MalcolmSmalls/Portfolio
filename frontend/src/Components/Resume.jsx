...
export default function Resume() {
  return (
    <div className='h-full bg-[#292929]' id='resume'>
      <h2 className='text-white font-BebasNeue text-5xl text-center underline underline-offset-8 decoration-red-500 decoration-double pt-10 lg:pt-20'>
        Resume
      </h2>
      <div className=' z-12 relative bg-[#292929]  mt-6'>
        <div className='container flex lg:flex-row flex-col p-8 mx-auto lg:w-3/4 w-full gap-10'>
          <div className='container flex flex-col flex-none lg:w-1/2 w-full'>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                ...
                self-paced online university paid for by my current employer
                which allows me to work fulltime while earning my degree
                fulltime.
              </p>
            </div>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                The Odin Project is a free online bootcamp featuring
                comprehensive reading, video tutorials and extensive projects
                for full stack software developers. Picking the JavaScript path,
                I've further increased my skills in frontend design, backend
                architectures, sorting algorithms and data structures.
              </p>
            </div>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                #100Devs is a completely free online bootcamp created by Leon
                Noel to help those financially affected by Covid-19. As my music
          ...
          <div className='container flex flex-col flex-none lg:w-1/2 w-full'>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                As a freelancer I've built e-commerce web applications for my
                own music production as well as for other upcoming musicians. I
                intend on going further by creating digital audio workstations,
                virtual instruments and other musical apps to empower creatives.
              </p>
            </div>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                ...
                program, I am able to go pursue my Bachelor's Degree for free as
                a fulltime employee.
              </p>
            </div>
            ...
            <div className='container flex flex-col bg-[#121212] font-Raleway text-white w-full h-50 rounded-lg p-6 mb-8'>
              ...
              <p className='font-semibold text-[#747474]'>
                ...
                well over 100k views. Beyond myself, I've extended my services
                to other local musicians by means of music production,
                collaboration, graphic design, mixing and mastering, songwriting
                and coaching.
              </p>
            </div>
          </div>
